...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-21 13:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/55ca1bb5-9a16-4bb4-ae32-b1ff341befe8.git
$ cd 55ca1bb5-9a16-4bb4-ae32-b1ff341befe8
```
